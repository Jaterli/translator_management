...
class Translator(AbstractBaseUser, PermissionsMixin):
    ...
    birth_date = models.DateField(null=True, blank=True, default="2000-01-01", verbose_name='Fecha de Nacimiento')
    registration_date = models.DateTimeField(null=True, blank=True, default="2000-01-01", verbose_name='Fecha de registro')
    last_access = models.DateTimeField(null=True, blank=True, default="2000-01-01", verbose_name='Último acceso')
...
class LanguageCombination(models.Model):
    translator = models.ForeignKey(Translator, on_delete=models.CASCADE, related_name='language_combinations')
